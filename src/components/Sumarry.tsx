...
const Summary: React.FC<SummaryProps> = ({ patient, appointment, paymentMethod, onBack, onFinalize }) => {
  return (
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 border border-gray-100 rounded-lg bg-gray-50 flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-2xl font-bold text-[#b91c1c]">{priceLabel(appointment.valor)}</div>
          </div>
        </div>
